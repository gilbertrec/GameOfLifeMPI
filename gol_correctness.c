...
int main (int argc, char** argv){
    ...
    //the only difference is that the gather is applied on each generation and the master print the current gen matrix
